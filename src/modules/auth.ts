...
export async function login(request: FastifyRequest<LoginProps>, reply: FastifyReply) {
	try {
...
export async function register(request: FastifyRequest<RegisterProps>, reply: FastifyReply) {
	try {
